...
All data processing—loading, merging, reshaping, and matching—is handled by the `preprocessing` module. This ensures a single source of truth for both the writeup and the Streamlit app.
