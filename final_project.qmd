...
chart9.save("code/presentation_top10_ged.png", scale_factor=2)
```

![Top 10 Countries by Conflict Events, 1994–2024 (Colombia highlighted)](code/presentation_top10_ged.png){width=85%}
...
fig.savefig("code/conflict_map_colombia.png", dpi=200, bbox_inches="tight", facecolor="white")
plt.show()
```
...
plt.tight_layout(rect=[0, 0.03, 1, 0.97])
fig2.savefig("code/mines_map_colombia.png", dpi=200, bbox_inches="tight", facecolor="white")
plt.show()
```
...
plt.tight_layout(rect=[0, 0.03, 1, 0.97])
fig_v.savefig("code/mines_victims_map_colombia.png", dpi=200, bbox_inches="tight", facecolor="white")
plt.show()
```
...
chart.save("code/scatter_conflict_vs_mines.png", scale_factor=2)
chart
```
...
plt.tight_layout(rect=[0, 0.03, 1, 0.97])
fig4.savefig("code/quadrants_conflict_mines_map.png", dpi=200, bbox_inches="tight", facecolor="white")
plt.show()
```
...
plt.tight_layout(rect=[0, 0.03, 1, 0.97])
fig5q.savefig("code/quadrants_with_mines_map.png", dpi=200, bbox_inches="tight", facecolor="white")
plt.show()
```
...
chart7.save("code/temporal_conflict_mines.png", scale_factor=2)
chart7
```
...
chart8.save("code/temporal_demining.png", scale_factor=2)
chart8
```
